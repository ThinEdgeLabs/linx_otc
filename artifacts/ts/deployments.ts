...
import { Loan, LoanInstance, LendingMarketplace, LendingMarketplaceInstance } from '.'
...
export type Deployments = {
  ...
  contracts: {
    LendingOffer: DeployContractExecutionResult<LoanInstance>
...
function toDeployments(json: any): Deployments {
  const contracts = {
    LendingOffer: {
      ...
      contractInstance: Loan.at(json.contracts['LendingOffer'].contractInstance.address)
    },
    LendingMarketplace: {
      ...json.contracts['LendingMarketplace'],
      contractInstance: LendingMarketplace.at(json.contracts['LendingMarketplace'].contractInstance.address)
    }
  }
  return {
    ...json,
