...
<template>
  <button
    ...
    @click="toggleModal"
    class="px-[20px] py-[10px] rounded-[20px] bg-gradient-to-r from-accent-1 to-accent-2 text-[14px] text-core-lightest font-semibold hover:bg-none hover:bg-accent-2"
  >
    Connect wallet
  </button>
  <button
